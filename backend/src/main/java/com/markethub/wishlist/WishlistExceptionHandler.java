...
public class WishlistExceptionHandler {
 ...
 @ExceptionHandler(InvalidWishlistRequestException.class) ResponseEntity<ApiErrorResponse> badRequest(RuntimeException e){return response(HttpStatus.BAD_REQUEST,e);}
